    ...
    <div class="fixed top-0 left-0 right-0 bg-black z-50 px-8 py-3">
      <div class="flex items-center gap-8">
        ...
        <nav class="flex items-center gap-6">
          ...
          <router-link to="/parameters" class="text-white font-medium border-b-2 border-white pb-1 text-sm">Parameters</router-link>
...
const pct = (value, capacity) => {
  ...
  return Math.round((parseFloat(value) / parseFloat(capacity)) * 100);
};
