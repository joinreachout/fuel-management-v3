  ...
  <div class="min-h-screen bg-gray-50">
    ...
    <div class="fixed top-0 left-0 right-0 bg-black z-50 px-8 py-3">
      <div class="flex items-center gap-8">
        ...
        <nav class="flex items-center gap-6">
          ...
          <a href="/import" class="text-white font-medium border-b-2 border-white pb-1 text-sm">Import</a>
    ...
    <div class="max-w-7xl mx-auto px-6 py-8">
      <div class="bg-white rounded-2xl shadow-lg p-12 text-center">
        <i class="fas fa-file-import text-6xl text-purple-500 mb-6"></i>
        <h1 class="text-3xl font-bold text-gray-800 mb-4">Data Import</h1>
        <p class="text-gray-600 mb-8">Data import functionality will be implemented here</p>
        <div class="inline-flex items-center px-6 py-3 bg-purple-50 border border-purple-200 rounded-lg text-sm text-purple-800">
...
<script setup>
// Import page logic will be implemented here
</script>
